	...
	return (
		...
		>
			...
			>
				...
				>
					<div className={`app-topbar blur uk-border-rounded uk-grid uk-margin-remove ${isMac ? 'macos-topbar' : ''}`}>
						{isMac && (
							<div className="app-top-functions macos-functions uk-flex">
								<div
									className="macos-btn close"
									onClick={() => handleAppFunctionClick(props.appInfo, ACTION_TYPES.CLOSE)}
								></div>
								<div
									className="macos-btn minimize"
									onClick={() => handleAppFunctionClick(props.appInfo, ACTION_TYPES.MINIMIZE)}
								></div>
								<div
									className="macos-btn maximize"
									onClick={() => handleAppFunctionClick(props.appInfo, ACTION_TYPES.MAXIMIZE)}
								></div>
							</div>
						)}
						...
						{!isMac && (
							<div className="app-top-functions windows-functions uk-flex">
								<IconButton
